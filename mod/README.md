...
- **Nearby objects** lists what you can use that is in view around you: things you can pick up first, then containers and stairs, each nearest first. Repeats of the same thing fold into one row with a count. Options can narrow it to takeable items only.
